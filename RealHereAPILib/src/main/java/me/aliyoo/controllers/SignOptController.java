...
public class SignOptController extends BaseController {    
    ...
    public void createLaunchSignAsync(
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5430813399793723657L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5556367920101324073L;
            {
    ...
    public void getSignHistoryAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5249591327289043475L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5583872496645038882L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void getSignStatisticsAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5124427935185652468L;
            {
                    put( "confcID", confcID );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4765574632159858487L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "email", email );
            }
    ...
    public void getSignableConferenceAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5620853693453360456L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4799224507703402433L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void createToSignAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5579400700578499897L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4904441084984182496L;
            {
                    put( "confcID", confcID );
                    put( "email", email );
            }
