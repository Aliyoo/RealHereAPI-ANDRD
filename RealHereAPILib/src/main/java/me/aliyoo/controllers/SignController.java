...
public class SignController extends BaseController {    
    ...
    public void createLaunchSignAsync(
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5473693021937429692L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5374776769849110965L;
            {
    ...
    public void getSignableConferenceAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5547359345901293193L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4671752938630475520L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "apikey", apikey );
            }
    ...
    public void createToSignAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5698731648463390119L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "apikey", apikey );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5525619091162418120L;
            {
                    put( "confcID", confcID );
                    put( "email", email );
            }
    ...
    public void getSignHistoryAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4873463167725377231L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4858062114750329827L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "apikey", apikey );
            }
    ...
    public void getSignStatisticsAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5696751676149799071L;
            {
                    put( "confcID", confcID );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5290671937685352670L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "apikey", apikey );
                    put( "email", email );
