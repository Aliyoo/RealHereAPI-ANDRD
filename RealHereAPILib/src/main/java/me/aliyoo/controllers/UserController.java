...
public class UserController extends BaseController {    
    ...
    public void createLoginAsync(
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5296603285841083135L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4957654306139134278L;
            {
                    put( "email", email );
    ...
    public void modifyUserInfoAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5351723039451490291L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "apikey", apikey );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5099064202374549665L;
            {
                    put( "email", email );
                    put( "userCom", userCom );
    ...
    public void getUserInfoAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5554983770911254986L;
            {
                    put( "email", email );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5308555517473413629L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void createLogUpAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5169729555512908936L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "apikey", apikey );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5685532850881001671L;
            {
                    put( "email", email );
                    put( "pwd", pwd );
            }
