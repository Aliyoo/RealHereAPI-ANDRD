...
public class ConferenceController extends BaseController {    
     ...
     */
    public void getConferenceDetailAsync(
                final int confcID,
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5140841054087188582L;
            {
                    put( "confcID", confcID );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4715715344639606984L;
            {
    ...
    public void addConferenceAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4626056270510757496L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5360615882014694643L;
            {
    ...
    public void createDeleteConferenceAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4718824528926259534L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5399538536824587201L;
            {
                    put( "confcID", confcID );
                    put( "email", email );
            }
    ...
    public void getFilterConferencesAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4815400441007888403L;
            {
                    put( "size", size );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5173362001002403276L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
