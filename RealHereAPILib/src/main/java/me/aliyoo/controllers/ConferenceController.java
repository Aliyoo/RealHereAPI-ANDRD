...
public class ConferenceController extends BaseController {    
    ...
    public void getConferenceInfoAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5097683724230118254L;
            {
                    put( "confcID", confcID );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5701453336343801076L;
            {
    ...
    public void addConferenceAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5593588058685278081L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "email", email );
            }
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4728593244585120191L;
            {
    ...
    public void createDeleteConferenceAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5416400181781410999L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "email", email );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4665278778274153426L;
            {
                    put( "confcID", confcID );
            }
        };
    ...
    public void getFilterConferencesAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4957788071737440581L;
            {
                    put( "size", size );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5702152661857403135L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void modifyConferenceAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5327058331991182787L;
            {
                    put( "confcDuration", confcDuration );
                    put( "confcID", confcID );
            }});
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5025894877549067073L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "email", email );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5360621378457842717L;
            {
                    put( "confcDetail", confcDetail );
                    put( "confcLocation", confcLocation );
                    put( "confcOrger", confcOrger );
